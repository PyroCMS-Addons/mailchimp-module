 ...
 */
class MailchimpModuleSections extends Module
{

    public function handle(ControlPanelBuilder $builder, PreferenceRepositoryInterface $preferences)
    {
        //$view = $preferences->value('thrive.module.mailchimp::preference', 'default');
        ...
        $sections =             [
            ...
            'webhooks' => [
                ...
                'buttons' => [
                    'pull_webhooks' => [
                        'text' => 'Pull',
                        'href' => 'admin/mailchimp/webhooks/pull',
                        'type' => 'danger',
                        'icon' => 'download',
                        'attributes' => [
                            'data-icon'     => 'warning',
        ...
        // {
        //     unset($sections['subscribers']['buttons']);
        // }
